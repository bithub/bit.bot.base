...
handle_message = function() {
	...
	console.log("handle_message called on empty receive queue");
        return;
    }
    switch (rfb_state) {
    case 'disconnected':
    ...
    case 'normal':
		...
		console.log("More data to process, existing timer");
...
init_msg = function() {
    ...
    case 'ServerInitialisation' :
        ...
        var screen_info =("Screen: " + fb_width + "x" + fb_height + 
			  ", bpp: " + bpp + ", depth: " + depth +
